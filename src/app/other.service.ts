...
export class OtherService {
  ...
  private _getFollowedUsersURL = 'http://localhost:3000/api/profile/getFollowedUsers';
  private _getFollowersURL = 'http://localhost:3000/api/profile/getFollowers';
  /* ---------- timeline ----------- */
  ...
  private _getRelevantPostURL = 'http://localhost:3000/api/timeline/getRelevantPosts';
  /* ---------- post ----------- */
  ...
  getFollowedUsers() {
    return this.http.post(this._getFollowedUsersURL, {});
  }
  getFollowers() {
    return this.http.post(this._getFollowersURL, {});
  }
  /* ---------- timeline ----------- */
  getMorePosts() {
  ...
  getRelevantPost () {
    return this.http.post(this._getRelevantPostURL,  {});
  }
  /* ---------- post ----------- */
  createNewPost(post) {
